...
ここに置いてあるものは **まだどこにも送っていない。**

送る前に、**diff が名指しする platform は一つずつ実際に動かす**。動かしていない
行を「Not tested: X」と書き添えて出すのは駄目で、X を diff から外して逃げるのも
駄目。箱が無いことが本当になるのは、vmactions の image にも自前の image にも
無く、作ることもできなかったときだけで、それは報告する事であって diff に書く
事ではない。
